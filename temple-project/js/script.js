...
const apiURL = "https://api.openweathermap.org/data/2.5/forecast?q=Aba&units=metric&cnt=3&appid=a78ec261e24b796f729e2597d514690b"; // Celcius
...
let button3 = document.querySelector(".clickme3");
...
button2.onclick = function() {
  counter2 += 1;
  button2.innerHTML = "Like " + counter2;
};
counter3 = 0;
button3.onclick = function() {
  counter3 += 1;
  button3.innerHTML = "Like " + counter3;
};
